...
export default function ProductsPage() {
  ...
  useEffect(() => { customerApi.getCategories().then(setCategories).catch(() => {}) }, [])
  useEffect(() => {
    setLoading(true); setError('')
    customerApi.getProducts({ page, size: 20, categoryId: category || undefined, keyword: keyword || undefined })
